...
public class Product {
    ...
    public Product(String id, String name, String category, double price, String description, String imageUrl, boolean available, String idInvoice, double profitMargin) {
        this.id = id;
        this.name = name;
